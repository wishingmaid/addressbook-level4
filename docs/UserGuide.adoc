...
=== Locating persons by phone number: `findphone` (Since v1.2)
...
* Only full phone number will be matched.
...
* `findphone 98765432` +
Returns contact with phone number `9876432`.
* `findphone 98765432 91234567` +
Returns contacts with phone number `98765432` and `91234567`.
...
=== Store contact's birthday : `birthday` (Coming in v2.0)

Adds a birthday parameter to a contact. +
