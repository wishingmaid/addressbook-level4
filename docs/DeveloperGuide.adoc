...
|`* * *` |user |find a person by date added |locate details of a persons without having to go through the entire list
...
|`* *` |user |to create favourite lists of contacts |find my most important contacts easily
...
|`*` |user | add pictures to my contacts |better identify them with a picture
